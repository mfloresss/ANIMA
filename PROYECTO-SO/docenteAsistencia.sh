...
function validationCI(){
    clear
        ...
        then
            ...
            then
                # Si la búsqueda de grep dada la ci en esta fecha devuelve algo, quiere decir que esta ci fue registrada
                validateAssist=$(grep -w $ci /home/anima/proyecto/db/docentes)
                if [ -z "$validateAssist" ];
                then
        clear
        echo "==============================================================="
        echo
        echo "      No existe un docente con esas credenciales"
        echo
        echo "==============================================================="
        sleep 2
        clear
